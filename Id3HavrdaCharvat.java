...
/*
 *    Id3HavrdaCharvat.java
 *    This is a modification of the official ID3 Weka implementation from 1999 University of Waikato, Hamilton, New Zealand
 *    The computeEntropy function implement Havrda-Charvat entropy instead of Shannon entropy.
 *    The alpha variable is available through Weka GUI, alpha must be between 0 and 1.
 */
...
public class Id3HavrdaCharvat 
  ...
  private Id3HavrdaCharvat[] m_Successors;
  ...
  private void makeTree(Instances data) throws Exception {
    ...
    if (Utils.eq(infoGains[m_Attribute.index()], 0)) {
      ...
      m_Successors = new Id3HavrdaCharvat[m_Attribute.numValues()];
      for (int j = 0; j < m_Attribute.numValues(); j++) {
        m_Successors[j] = new Id3HavrdaCharvat();
  ...
  public static void main(String[] args) {
    runClassifier(new Id3HavrdaCharvat(), args);
  }
}
